    ...
    internal class Repository:DbContext
    {
        ...
        public Repository() : base(GetConnection(), false)
        {
            if (Database.CreateIfNotExists())
            {
                ...
                Credential c1 = new Credential("dkatdavi@gmail.com", "dkat", true, true);
                d1.Credential = c1;
                c1.Developer = d1;

                Developer d2 = new Developer("Pedro Isaque", new DateTime(2008, 06, 09), 'P');
                Credential c2 = new Credential("piatpedro@gmail.com", "piat", true, true);
                d2.Credential = c2;
                c2.Developer = d2;

                Developer d3 = new Developer("Sebastião Juares", new DateTime(1969, 01, 10), 'S');
                Credential c3 = new Credential("sjtjuares@gmail.com", "sjt", true, true);
                d3.Credential = c3;
                c3.Developer = d3;

                Developer d4 = new Developer("Giane Aparecida", new DateTime(1978, 09, 22), 'P');
                Credential c4 = new Credential("gaatgiane@gmail.com", "gaat", true, false);
                d4.Credential = c4;
                c4.Developer = d4;

                Developer d5 = new Developer("Matheus Alexander", new DateTime(1995, 09, 05), 'P');
                Credential c5 = new Credential("maatmatheus@gmail.com", "maat", true, false);
                d5.Credential = c5;
                c5.Developer = d5;

                Developer d6 = new Developer("Ana Gabriela", new DateTime(1999, 01, 19), 'J');
                Credential c6 = new Credential("agatgabriela@gmail.com", "agat", true, false);
                d6.Credential = c6;
                c6.Developer = d6;
                //--//
